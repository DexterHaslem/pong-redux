...
var Draw = exports.Draw = function () {
    ...
    _createClass(Draw, [{
        ...
        value: function update(state) {
            ...
            // Create gradient
            var gradient = ctx.createLinearGradient(0, 0, _constants.Constants.WIDTH, 0);
...
var gameStore = (0, _redux.createStore)((0, _redux.combineReducers)({ game: _reducers.game, cpu: _reducers.cpu, player: _reducers.player }));
...
},{"./actions":16,"./draw":18,"./reducers":20,"redux":7}],20:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.cpu = exports.game = exports.player = undefined;
...
var getDefaultGameState = function getDefaultGameState() {
    return {
        ...
        ballSpeed: 50,
        ballDirection: _Constants.Constants.Left
    };
};

var player = exports.player = function player() {
    var state = arguments.length <= 0 || arguments[0] === undefined ? getDefaultPlayerState() : arguments[0];
    var action = arguments[1];
